...
public class DeleteDBCommand implements QueryCommand {
    ...
    @Autowired
    public DeleteDBCommand(DatabaseService databaseService, AffinityManager affinityManager, BroadcastService broadcastService){
    ...
    public void broadcastOperation(JSONObject details) {
        System.out.println("Starting broadcasting database deletion to others..");
