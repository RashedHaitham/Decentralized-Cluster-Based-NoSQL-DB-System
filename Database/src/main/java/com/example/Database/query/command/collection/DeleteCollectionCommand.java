...
public class DeleteCollectionCommand implements QueryCommand {
    ...
    @Autowired
    public DeleteCollectionCommand(CollectionService collectionService, AffinityManager affinityManager, BroadcastService broadcastService) {
    ...
    public void broadcastOperation(JSONObject details) {
        System.out.println("Starting broadcasting collection deletion to others..");
